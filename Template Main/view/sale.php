						...
						<div class="shop-sidebar">
								...
								<div class="single-widget category">
									...
									<ul class="categor-list">
										<li><a href="index.php?action=getAllboys&&designation='boybaby'&controller=ProdBabies">BOYS</a></li>
										<li><a href="index.php?action=getAllgirls&&designation='girlbaby'&controller=ProdBabies">GIRLS</a></li>
										<li><a href="index.php?action=getAllBabieS&&designation='baby'&controller=ProdBabies">BABIES</a></li>	
...
<span class="price-dec"><?php echo $p->promotion ?>%</span>
										</a>

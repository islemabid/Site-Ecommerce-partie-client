					...
					<div class="col-lg-3 col-md-4 col-12">
						<div class="shop-sidebar">
								...
								<div class="single-widget category">
									...
									<li><a href="index.php?action=getAllCostume&&designation='costume'&controller=ProdHomme">suits</a></li>
		<li><a href="index.php?action=getAllshirt&&designation='T-shirt'&controller=ProdHomme">T-shirt</a></li>
	   <li><a href="index.php?action=getAlljeans&&designation='jeans'&controller=ProdHomme">jeans</a></li>
	   <li><a href="index.php?action=getAllpant&&designation='pantallon'&controller=ProdHomme">Formal Pant</a></li>
...
<?php echo "<img  class=\"default-img\" src=\"uploads/products/$p->photo\"  />";?>
<?php echo "<img  class=\"hover-img\" src=\"uploads/products/$p->photo\"   />";?>
										</a>
